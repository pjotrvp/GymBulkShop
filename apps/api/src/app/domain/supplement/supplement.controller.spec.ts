...
import { Supplement, SupplementDocument, SupplementSchema } from './supplement.schema';
import { SupplementService } from './supplement.service';
import { MongoClient } from 'mongodb';
import { MongoMemoryServer } from 'mongodb-memory-server';
import { SupplementModule } from './supplement.module';
import { NEO4J_CONFIG, NEO4J_DRIVER } from '../../Infrastructure/neo4j/neo4j.constants';
...
describe('SupplementController', () => {
    ...
    beforeAll(async () => {
        ...
        controller = module.get<SupplementController>(SupplementController);
            ...
            supplementModel = module.get<Model<SupplementDocument>>(getModelToken(Supplement.name));
